...
export N_GPUS=8
export EXPERIMENT_NAME="difficulty-curriculum"
...
export EPOCHS=1
bash /home/cmu/countdown-curriculum/scripts/grpo/difficulty_curriculum/grpo.sh > /home/cmu/countdown-curriculum/logs/$EXPERIMENT_NAME-part-1.log 2>&1
...
export EPOCHS=1
bash /home/cmu/countdown-curriculum/scripts/grpo/difficulty_curriculum/grpo.sh > /home/cmu/countdown-curriculum/logs/$EXPERIMENT_NAME-part-2.log 2>&1
...
export EPOCHS=1
bash /home/cmu/countdown-curriculum/scripts/grpo/difficulty_curriculum/grpo.sh > /home/cmu/countdown-curriculum/logs/$EXPERIMENT_NAME-part-3.log 2>&1
